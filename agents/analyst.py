...
def analyst_node(state: AgentState) -> dict:
    ...
    try:
        ...
        reason = "Fallback: Bull Put Spread proposed."
        offset_short = 5.0
        offset_long = 10.0
    ...
    if signal == "BUY" and strategy == "BULL_PUT_SPREAD":
        # Let's locate the closest option contracts in our option_chain
        # Short put: strike closest to S - offset_short
        # Long put: strike closest to S - offset_long
